...
public class GameWindow {
    ...
    public GameWindow(Stage stage, int width, int height) {
        ...
        //Communicator for multiplayer, add endpoint if required!
    ...
    /**
     * Displays multiplayer game
     * @param players current players in game
     * @param currentPlayer name of the current player
     */
    public void startMultiplayerGame(ArrayList<String> players, String currentPlayer) {
        loadScene(new MultiplayerScene(this, players, currentPlayer));
    }
